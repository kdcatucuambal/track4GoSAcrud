...
const UpdateUser = ({ match }: RouteChildrenProps) => {
    ...
    const showError = () => {
        toast.current.show({ severity: 'error', summary: 'Error en datos', detail: 'Los datos están mál ingresados', life: 3000 });
    }
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        dispatch(updateUserAction(match.params["id"],user));
        history.push("/");
    }
                    ...
                    <div className="p-fluid">
                        <form onSubmit={handleSubmit}>
                            <div className="p-field">
                                ...
                                <InputText id="identificationCard"
